...
"@, $utf8WithoutBom)
    ...
    Require-Match $articleMarkup '2026 年 8 月 14 日</span>&nbsp;·&nbsp;<span>3 分钟</span>&nbsp;·&nbsp;<span>469 字</span>&nbsp;·&nbsp;<span>ZestJT</span>' "Article metadata should match the Chinese reading-first reference copy."
