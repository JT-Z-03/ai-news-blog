---
title: "AI 热点日报 | 2026年7月23日"
date: 2026-07-23T08:00:00+08:00
draft: false
tags: ["AI", "日报"]
categories: ["日报"]
slug: ai-hot-2026-07-23
description: 2026年7月23日 AI 圈要闻：腾讯设计Agent平台Miora全面开放，GigaToken发布提速1000倍，微软MagenticLite全面开源，Cursor发布智能模型路由系统，小红书开源BigMac多模态训练范式，AMD投资50亿Anthropic采购2GW GPU，Alphabet Q2营收增长24%。
---
...
🔗 [公众号：数字生命卡兹克](https://mp.weixin.qq.com/s/qQhq9nxoeCD68iMwQoEVFQ)
...
🔗 [Hacker News 热门（buzzing.cc 中文翻译）](https://github.com/marcelroed/gigatoken)
...
🔗 [X：Microsoft Research (@MSFTResearch)](https://x.com/MSFTResearch/status/2079989338994069511)
...
🔗 [Anthropic：Newsroom（网页）](https://www.anthropic.com/news/anthropic-economic-index-connector)
...
🔗 [公众号：小红书技术（dots.llm）](https://mp.weixin.qq.com/s/tNJARtn1jIayL5URg87Row)
...
🔗 [Claude Code：GitHub Releases（RSS）](https://github.com/anthropics/claude-code/releases/tag/v2.1.218)

### 三星 Galaxy Unpacked 2026：Gemini Intelligence 1 任务自动化、Gemini Notebook 及智能眼镜等三项更新

三星 Galaxy Z Fold8 Ultra、Fold8 及 Flip8 首发搭载 Gemini Intelligence 1，其任务自动化功能从少数应用扩展至超过 40 款，支持购物、订餐、预订旅行等，并新增屏幕理解与复杂图像解析能力。

🔗 [Google Blog：AI（RSS）](https://blog.google/products-and-platforms/platforms/android/galaxy-unpacked-2026)
...
AMD 刚刚宣布与 Anthropic 达成协议，将投资高达 50 亿美元，换取 Anthropic 采购 2GW 的 AMD MI455 UALOE72 及未来 GPU。

🔗 [X：SemiAnalysis (@SemiAnalysis_)](https://x.com/SemiAnalysis_/status/2079929602429141215)
...
🔗 [X：Sundar Pichai (@sundarpichai)](https://x.com/sundarpichai/status/2080021408856293584)

### Anthropic 设立 2 亿美元经济未来研究基金，支持外部研究

Anthropic 承诺投入 2 亿美元成立 Anthropic Economic Futures Research Fund，用于资助外部研究。该基金旨在支持具有前瞻性的经济影响研究项目。

🔗 [Anthropic：Newsroom（网页）](https://www.anthropic.com/news/economic-futures-research-fund-agenda)

### OpenAI 在佐治亚州 Effingham 县启动 Project Camellia 数据中心项目

OpenAI 宣布在佐治亚州 Effingham 县启动 Project Camellia，承诺负责任能源、社区投资、就业岗位及 Codex 访问权限。该项目聚焦 AI 基础设施建设。

🔗 [OpenAI：官网动态（RSS）](https://openai.com/index/building-ai-infrastructure-with-the-effingham-county-community)

### OpenAI 与美国能源部及国家实验室合作，推动前沿 AI 加速科学发现

OpenAI 宣布与美国能源部及国家实验室合作，利用前沿 AI 加速科学发现。合作旨在推动美国科学事业进入新阶段，通过 AI 技术提升研究效率与突破速度。

🔗 [OpenAI：官网动态（RSS）](https://openai.com/index/advancing-the-next-era-of-national-science)

### Google DeepMind 为 Genesis Mission 提供 4000 万美元 AI tokens 和 credits

Google 承诺为 Genesis Mission 提供 4000 万美元的 AI tokens 和 credits，以加速科学发现的前沿探索。这笔资金将用于支持研究人员利用 AI 工具推动生物学、化学和材料科学等领域的突破。

🔗 [Google DeepMind：Blog（RSS）](https://deepmind.google/blog/accelerating-the-frontiers-of-scientific-discovery-googles-40m-commitment-to-the-genesis-mission)
...
🔗 [HuggingFace Daily Papers（社区热门论文）](https://arxiv.org/abs/2607.20379)
...
🔗 [OpenRouter：Announcements（RSS）](https://openrouter.ai/blog/tutorials/transcription-on-openrouter)
...
🔗 [公众号：卡尔的AI沃茨](https://mp.weixin.qq.com/s/PnXGmmDYejrHBSpoRBOHkg)
...
🔗 [Nathan Lambert：Interconnects（RSS）](https://www.interconnects.ai/p/open-models-recap-more-on-kimi-k3)
...
🔗 [Claude：Blog（网页）](https://claude.com/blog/building-verification-loops-in-claude-code-with-skills)

### Copilot vs. 直接 API 调用：你实际在为什么付费？

GitHub Copilot 现已按公布的 API 费率对使用量计费。与直接调用模型 API 相比，用户支付的额外费用覆盖了编码工作流、策略管理和工具集成等周边服务。

🔗 [GitHub Blog](https://github.blog/ai-and-ml/github-copilot/copilot-vs-raw-api-access-what-are-you-actually-paying-for)

### Outtake 在 Claude 上构建自主网络调查智能体 Recon Agent

AI 网络安全平台 Outtake 基于 Claude，使用 Claude Code 和 Agent SDK 构建了自主网络调查智能体 Recon Agent。

🔗 [Claude：Blog（网页）](https://claude.com/blog/how-outtake-built-a-cyber-investigator-on-claude)
