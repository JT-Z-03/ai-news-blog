...
tags: ["AI", "日报"]
categories: ["日报"]
slug: "ai-hot-2026-06-13"
description: "2026年6月13日 AI 圈要闻：MiniMax M3 开源权重模型发布，已上架 HuggingFace、Kimi 发布并开源最新代码模型 Kimi-K2.7-Code、苹果 iOS 27 健康 App 大改：卡片布局、营养识别、围绝经期追踪、olmo-eval：面向模型开发循环的评估工作台"
---
...
📎 [X：MiniMax (@MiniMax_AI)](https://x.com/MiniMax_AI/status/2065436935188058208)
...
📎 [X：Kimi.ai (@Kimi_Moonshot)](https://x.com/Kimi_Moonshot/status/2065377579130142937)
...
📎 [IT之家（RSS）](https://www.ithome.com/0/963/302.htm)
...
📎 [Hugging Face：Blog（RSS）](https://huggingface.co/blog/allenai/olmo-eval)
...
📎 [IT之家（RSS）](https://www.ithome.com/0/963/725.htm)
...
📎 [X：OpenAI (@OpenAI)](https://x.com/OpenAI/status/2065225362544726371)

### Codex 推出浏览器开发者模式

为 Chrome 和 Codex 内置浏览器引入开发者模式。 Codex 可以使用 Chrome DevTools 协议（CDP）来调试浏览器问题，通过分析 JavaScript 性能、检查控制台输出、网络流量和页面状态。

📎 [X：OpenAI Developers (@OpenAIDevs)](https://x.com/OpenAIDevs/status/2065226355495895521)
...
📎 [Claude Code：GitHub Releases（RSS）](https://github.com/anthropics/claude-code/releases/tag/v2.1.175)
...
📎 [Claude Code：GitHub Releases（RSS）](https://github.com/anthropics/claude-code/releases/tag/v2.1.174)
...
📎 [Claude Code：GitHub Releases（RSS）](https://github.com/anthropics/claude-code/releases/tag/v2.1.176)
...
📎 [Anthropic：Newsroom（网页）](https://www.anthropic.com/news/tcs-anthropic-partnership)
...
📎 [Google Research：Blog（网页）](https://research.google/blog/research-into-how-ai-can-help-users-understand-skin-conditions)
...
📎 [X：Oran Ge (@oran_ge)](https://x.com/oran_ge/status/2065566882774868125)
...
📎 [X：小互 (@xiaohu)](https://x.com/xiaohu/status/2065278092441268246)
...
📎 [X：Vista (@vista8)](https://x.com/vista8/status/2065264509170876417)
...
📎 [X：邵猛 (@shao__meng)](https://x.com/shao__meng/status/2065234132431675439)
...
📎 [Anthropic：Newsroom（网页）](https://www.anthropic.com/news/anthropic-public-record)

### OpenAI 推出面向新时代工作的新 Academy 课程

OpenAI 发布三门 Academy 课程，帮助用户掌握实用 AI 技能、创建可重复工作流，并在日常工作中应用 AI 智能体。

📎 [OpenAI：官网动态（RSS · 排除企业/客户案例）](https://openai.com/index/academy-courses-applying-ai-at-work)

### 如何在OpenRouter上获得最低成本的LLM推理

在OpenRouter上追加`:floor`可获取最便宜提供商，通过`max_price`设定花费上限，并可免费使用20多个零成本模型。同时需注意避免计费陷阱。

📎 [OpenRouter：Announcements（RSS）](https://openrouter.ai/blog/tutorials/how-to-get-the-lowest-cost-llm-inference-on-openrouter)
